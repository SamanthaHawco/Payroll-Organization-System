        ...
        
{
    ...
    */
    ...
    /**
     * Calculates and returns the amount owed to the employee
     * @return double
     */
    ...
    /**
     * Prints employee name and amount to be paid
     */
    public void printPayment(){
        System.out.println("Employee name: " + this.getName() + "; payment: "+this.amountToPay());
    }
    
    /**
     * compares names of hourly employees for sorting
     * @param anotherWorker
     * @return int
     */
    ...
    /**
     * produces clone of this hourly employee class
     * @return HourlyEmployee
     */
    public HourlyEmployee clone(){
     HourlyEmployee newWorker = (HourlyEmployee)super.clone();
     return newWorker;
    }
